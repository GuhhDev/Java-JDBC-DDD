...
import br.com.alura.jdbc.controller.PessoaController;
...
public class ProdutoCategoriaFrame extends JFrame {
	...
	private PessoaController produtoController;
	...
	public ProdutoCategoriaFrame() {
		...
		this.produtoController = new PessoaController();
	...
	private void preencherTabela() {
		List<Pessoa> produtos = listarProduto();
		try {
			for (Pessoa produto : produtos) {
	...
	private void salvar() {
		if (!textoNome.getText().equals("") && !textoDescricao.getText().equals("")) {
			Pessoa produto = new Pessoa(textoNome.getText(), textoDescricao.getText());
	...
	private List<Pessoa> listarProduto() {
